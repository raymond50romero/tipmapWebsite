...
export default function RestaurantDetailWindow() {
  ...
  const { averages, restaurant_name, restaurant_address, mapbox_id, allPosts } = selectedRestaurantData;
    ...
    <section className="window show-window" id="restaurant-detail-window">
      ...
      <div className="restaurant-detail-content">
        ...
        <div className="detail-ratings">
          <h2 className="detail-section-header">Ratings</h2>
          <div className="ratings-grid">
            ...
            <div className="detail-rating-item">
              ...
              <DollarRating rating={parseFloat(averages?.weekday_tips_average || 0)} />
            </div>
            <div className="detail-rating-item">
              <span>Weekend Tips:</span>
              <DollarRating rating={parseFloat(averages?.weekend_tips_average || 0)} />
            </div>
            <div className="detail-rating-item">
              <span>Management:</span>
              <StarRating rating={parseFloat(averages?.management_average || 0)} />
            </div>
            <div className="detail-rating-item">
              <span>Environment:</span>
              <StarRating rating={parseFloat(averages?.work_environment_average || 0)} />
            </div>
            <div className="detail-rating-item">
              <span>Clientele:</span>
              <StarRating rating={parseFloat(averages?.clientele_average || 0)} />
            </div>
          </div>
        </div>
